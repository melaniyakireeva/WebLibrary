...
var TuiRoot = class _TuiRoot {
  constructor() {
    ...
    this.scrollbars = this.nativeScrollbar || inject(TUI_IS_MOBILE) ? signal(false) : toSignal(inject(TUI_DIALOGS).pipe(map(({
      length
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _TuiRoot,
      selectors: [["tui-root"]],
      hostAttrs: ["data-tui-version", "4.12.0"],
      hostVars: 6,
      ...
      standalone: true,
      features: [ɵɵHostDirectivesFeature([TuiPlatform, TuiVisualViewport]), ɵɵStandaloneFeature],
