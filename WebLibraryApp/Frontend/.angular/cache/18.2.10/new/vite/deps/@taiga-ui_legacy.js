...
var _c13 = "[_nghost-%COMP%]{position:relative;display:block;block-size:1rem;box-sizing:border-box}.t-circle[_ngcontent-%COMP%]{position:absolute;inline-size:1rem;block-size:1rem;border-radius:100%;margin:0 -.5rem;box-shadow:inset 0 0 0 2px var(--tui-base-01),0 0 0 1px var(--tui-base-03)}";
...
function TuiSheetBarComponent_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(3, _c215, "rotate(-" + deg_r1 + "deg)"));
    ɵɵadvance();
    ɵɵproperty("ngIf", deg_r1);
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(5, _c215, "rotate(" + deg_r1 + "deg)"));
  }
}
var _c37 = ["sheet"];
var _c45 = ["content"];
