 ...
 */
export declare const TUI_FILE_OPTIONS: import("@angular/core").InjectionToken<TuiFileOptions>, tuiFileOptionsProvider: (item: Partial<TuiFileOptions>) => import("@angular/core").FactoryProvider;
