...
export declare class TuiAppBarBack implements TuiAppearanceOptions {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiAppBarBack, "button[tuiAppBarBack], a[tuiAppBarBack]", never, {}, {}, never, ["*"], true, [{ directive: typeof i1.TuiAppearance; inputs: {}; outputs: {}; }]>;
}
